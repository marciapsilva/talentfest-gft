...
function renderMap() {
  ...
  function showAgenciesLocation() {
    ...
    .addTo(map)
    L.marker([-23.557633, -46.662270]).addTo(map)

    data.map(agency => {
      L.marker([agency.lat, agency.long]).addTo(map)
  ...
  <div class="info">
    <p class="info-text"> Encontre aqui a agência mais próxima de você! </p>
    <p class="info-text"> Se deseja ver mais informações, clique nos pins. </p>
  </div>
   <a href="/" class="">Voltar</a>
  `;
  return templateMapPage;
}