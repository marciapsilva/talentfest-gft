const renderInsurance = () => {
  ...
  <div class="mx-5">
    ...
    <div class="tab row mx-1">
      <button id="house" class="col-4 tablinks text-size-2" onclick="securityOptions(event, 'Residencial')">Residencial</button>
      <button id="life" class="col-4 tablinks text-size-2" onclick="securityOptions(event, 'Vida')">Vida</button>
      <button id="car" class="col-4 tablinks text-size-2" onclick="securityOptions(event, 'Auto')">Auto</button>
    </div>
